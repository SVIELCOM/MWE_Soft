...
lan8742_IOCtx_t LAN8742_IOCtx = { ETH_PHY_IO_Init, ETH_PHY_IO_DeInit, ETH_PHY_IO_WriteReg, ETH_PHY_IO_ReadReg, ETH_PHY_IO_GetTick };
...
void HAL_ETH_MspInit(ETH_HandleTypeDef *heth)
{
	...
	/*
	 ...
	 RMII_MII_RXD1 ---------------------> PC5
	 RMII_MII_RXER ---------------------> PG2
	 RMII_MII_TX_EN --------------------> PB11 (для ШВУ)
	 RMII_MII_TXD0 ---------------------> PB12 (для ШВУ)
	 RMII_MII_TXD1 ---------------------> PB13
	 */
...
//	GPIO_InitStructure.Pin = GPIO_PIN_2;
	//| GPIO_PIN_13; /* закомментировано мной*/
//	HAL_GPIO_Init(GPIOG, &GPIO_InitStructure); /* закомментировано мной*/
